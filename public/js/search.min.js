...
const conceptes=[{value:"alliberar",text:"ALLIBERAR"}];(()=>{const e=function(e){return e.replace(/à/g,"a").replace(/[èé]/g,"e").replace(/[íï]/g,"i").replace(/[òó]/g,"o").replace(/[úü]/g,"u")},t=new TomSelect("#cerca-concepte",{options:conceptes,create:!1,refreshThrottle:0,openOnFocus:!1,placeholder:"Introduïu un concepte",onChange:function(e){e&&(window.location.href="/concepte/"+encodeURIComponent(e))},render:{option:function(e,t){return"<div>"+e.text+"</div>"},item:function(e,t){return"<div>"+e.text+"</div>"},no_results:function(e,t){return"<div class='no-results'>No s'ha trobat cap resultat</div>"}},searchField:[],sortField:[],onType:function(t){const o=this;if(o.clearOptions(),t.length){const n=e(t.toLocaleLowerCase()),c=[],s=[];conceptes.forEach(function(t){const o=e(t.value.toLocaleLowerCase());o.startsWith(n)?c.push(t):o.includes(n)&&s.push(t)});c.concat(s).forEach(function(e){o.addOption(e)}),o.refreshOptions()}}});window.addEventListener("pageshow",function(){if(document.getElementById("cerca-concepte").value)return t.clear(!0),void t.focus();const e=document.getElementById("frase");e.value=new URLSearchParams(location.search).get("frase")||"",e.focus(),e.value&&!/Android|iPad|iPhone/i.test(navigator.userAgent)&&e.select()})})(),(()=>{const e=document.querySelector(".navbar-toggler"),t=document.querySelector("#navbar-collapse");e.addEventListener("click",function(){t.classList.contains("collapse")?(t.classList.remove("collapse"),t.classList.add("show")):(t.classList.add("collapse"),t.classList.remove("show"))})})();
